...
public class TelaDeletarConsulta extends javax.swing.JFrame {
    ...
    public TelaDeletarConsulta() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeletarConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    listarConsultas();
        ...
        submitExcluirConsulta.addActionListener((java.awt.event.ActionEvent evt) -> {
            String selectedItem = (String) jComboBoxExcluir.getSelectedItem();
        
            if (selectedItem != null && !selectedItem.isEmpty() && !selectedItem.equals("Selecione a consulta")) {
                try {
                    ...
                    if (sucesso) {
                        ...
                        JOptionPane.showMessageDialog(null, "Consulta excluída com sucesso. ID: " + id);
                        jComboBoxExcluir.removeItem(selectedItem); // Remove a consulta da lista imediatamente
                        ...
                        JOptionPane.showMessageDialog(null, "Ocorreu um erro ao excluir consulta.");
                    }
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(null, "Formato de ID inválido: " + ex.getMessage());
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Ocorreu um erro ao excluir consulta. Erro: " + ex);
                }
            } else {
...
public void listarConsultas() {
    try {
        ConsultaController consultaController = new ConsultaController();
        ArrayList<Consulta> consultas = consultaController.listarConsultas("");
        ...
        if (consultas.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Não há mais consultas.");
        } else {
            model.addElement("Selecione a consulta"); 
            for (Consulta consulta : consultas) {
                String item = consulta.getId() + " - Paciente: " + consulta.getPacienteNome() + " - Médico: " + consulta.getMedicoNome();
            ...
            jComboBoxExcluir.setRenderer(new DefaultListCellRenderer() {
                ...
                public Component getListCellRendererComponent(JList<?> list, Object value, 
                    ...
                    if (value != null && value.equals("Selecione a consulta")) {
        ...
        JOptionPane.showMessageDialog(null, "Ocorreu um erro ao listar as consultas. Erro: " + ex);
    }
}
    ...
    private void initComponents() {
        ...
        submitExcluirConsulta = new javax.swing.JButton();
        ...
        TitleDeletarMedico.setText("Deletar Consulta");
        ...
        submitExcluirConsulta.setFont(new java.awt.Font("Inter", 1, 12)); // NOI18N
        submitExcluirConsulta.setForeground(new java.awt.Color(0, 51, 153));
        submitExcluirConsulta.setText("OK");
        submitExcluirConsulta.addActionListener(new java.awt.event.ActionListener() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(submitExcluirConsulta)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDeletarConsulta().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton submitExcluirConsulta;
